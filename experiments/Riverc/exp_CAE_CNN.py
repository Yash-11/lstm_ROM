...
class ParamsManager:
    ...
    def __init__(self, ep):
        ...
        self.timeStepsUnroll = [70]

        # data
        self.numSampData = [101]
        self.numSampTrain = [60]
        self.numSampValid = [5]
        self.numSampTest = [1]
        self.reduce = [True]
        ...
        # AEtesting
        self.loadAEWeightsEpoch = [700]
        self.batchSizeTestAE = [1]
        self.batchSizeEncode = [1]

        # AEdata
        self.numSampTrainAE = [80]
        self.numSampTestAE = [10]
        self.numSampValidAE = [10]
...
def addName(hpDict):
    ...
    runName = f'results_CAE_CNN_l1_ld{ld}_sql{sql}_krs{krs}_lr{lr}_trSmp{trs}_ch{chn}_bs{bs}_{rnd}'
