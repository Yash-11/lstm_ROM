...
class ParamsManager:
    ...
    def __init__(self, ep):
        ...
        self.num_channels = [[100, 100], [200, 200], [50, 50]]
        # self.output_size = [50]
        self.kernel_size = [5, 3, 7]
        self.dropout = [0]
...
def addName(hpDict):
    ...
    runName = f'results_lstmSwap_Re{Re}_sql{sql}_krs{krs}_lr{lr}_trSmp{trs}_ch{chn}_bs{bs}_{rnd}'
