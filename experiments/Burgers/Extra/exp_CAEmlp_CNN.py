...
from src.Burgers.BurgersCAE_mlpModel import AutoEncoder
...
def addName(hpDict):
    ...
    runName = f'mlpCAEresults_AE_CNNSwap_Re{Re}_ld{ld}_sql{sql}_krs{krs}_lr{lr}_trSmp{trs}_ch{chn}_bs{bs}_{rnd}'
