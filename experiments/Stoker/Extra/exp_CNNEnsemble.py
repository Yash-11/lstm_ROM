...
class ParamsManager:
    ...
    def __init__(self, ep):
        ...
        # model 
        self.seq_len = [20]
        self.num_channels = [[100, 100, 100], [300, 300], [200, 200, 200]]
        self.kernel_size = [9]
        self.dropout = [0]
...
def addName(hpDict):
    ...
    runName = f'CNNswapEnsemble_sql{sql}_krs{krs}_lr{lr}_trSmp{trs}_ch{chn}_bs{bs}_{rnd}'
