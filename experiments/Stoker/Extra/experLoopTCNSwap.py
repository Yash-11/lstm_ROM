...
from src.Stoker.StokerTCNDatasetSwap import DatasetClass
...
class ParamsManager:
    ...
    def __init__(self, ep):
        ...
        self.num_channels = [[200, 200, 200], [100, 100, 100], [50, 50, 50]]
        # self.output_size = [50]
    ...
    def addName(self, hpDict):
        ...
        runName = f'sql{sql}_lr{lr}_trSmp{trs}_ch{chn}__bs{bs}_{rnd}'
