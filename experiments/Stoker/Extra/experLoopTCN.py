...
from src.Stoker.StokerTCNDataset import DatasetClass
...
class ParamsManager:
    ...
    def __init__(self, ep):
        ...
        self.num_channels = [[16, 16], [32, 32], [64, 64]]
        # self.output_size = [50]
        self.kernel_size = [3]
    ...
    def addName(self, hpDict):
        ...
        runName = f'ld{ld}_sql{sql}_lr{lr}_trSmp{trs}_ch{chn}__bs{bs}_{rnd}'
