...
for index, row in df.iterrows():
    ...
    try:
        results(runName, minValidEpoch-50)
        results(runName, minValidEpoch+50)
    except: pass
...
# results('results_lstmSwap_sql20_krs9_lr0.001_trSmp250_ch100100100_bs10_8PA67', 1000)
# results('CNNswapEnsemble_sql20_krs9_lr3e-05_trSmp250_ch100100100_bs10_8PA67', 150)