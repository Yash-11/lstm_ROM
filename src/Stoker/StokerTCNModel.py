...
class Model(nn.Module):
    def __init__(self, hp, args):
        ...
        num_inputs = hp.latentDim
        num_channels = hp.num_channels
        output_size = hp.latentDim
        ...
        # self.conv1d = nn.Conv1d(num_channels[-1], hp.output_size, kernel_size=1)
    ...
    def forward(self, x):
        ...
        x = T.permute(x, (0, 2, 1))
        out = self.network(x)  # (currentBatchSize, hiddenDim, seqLen)
