...
class AutoEncoder(nn.Module):
    ...
    def __init__(self, hp, args):
        ...
        if hp.AE_Model == 9:
            self.n_chLatent = 1
            self.encoder = nn.Sequential(
                nn.Conv2d(1, 16, kernel_size=3, stride=1, padding=1, padding_mode='replicate'),
                nn.ReLU(),
                nn.MaxPool2d(kernel_size=2, stride=2),

                nn.Conv2d(16, 32, kernel_size=3, stride=1, padding=1, padding_mode='replicate'),
                nn.ReLU(),
                nn.MaxPool2d(kernel_size=2, stride=2),

                nn.Conv2d(32, 16, kernel_size=3, stride=1, padding=1, padding_mode='replicate'),
                nn.ReLU(),
                nn.MaxPool2d(kernel_size=2, stride=2),

                nn.Conv2d(16, 1, kernel_size=3, stride=1, padding=1, padding_mode='replicate'),
            )
